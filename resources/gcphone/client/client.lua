...
local KeyOpenClose = 27--<<DPAD UP (Like GTO:O)--19 -- DPAD DOWN (you have to hold it a bit-- love jay)  // OLD: --288 -- F2
...
local keypressThreshold = 40 -- each 100 is about 1 second ... 200 = ~2 Seconds
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
